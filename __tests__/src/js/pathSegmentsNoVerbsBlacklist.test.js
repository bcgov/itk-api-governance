...
class PathSegmentsNoVerbsBlacklist extends BaseSpectralTest {
  constructor() {
...
const testInstance = new PathSegmentsNoVerbsBlacklist();
...
components:
  ...
  parameters:
    IdParam:
      ...
      `,
      notExpected: ['path-segments-no-verbs-blacklist'],
    });
  });
